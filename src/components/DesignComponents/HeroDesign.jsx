...
const IntentionSection = () => {
  return (
    <section className="bg-[#2F352D] realtive text-[#ECEDE7] max-w-full py-50 md:py-12  min-h[80vh] md:min-h-[100vh] flex flex-row items-end ">
      <Navbar/>
      <div className=" flex flex-col justify-between w-full md:flex-row h-full gap-20  min-h-[180px] px-4">

        {/* Left: Main Heading */}
        <div className="w-full basis-1/2  ">
          <h2 className="font-merchant   text-[70px] md:text-[100px] leading-16 md:leading-24 text-[#E3E8E0]">
            DESIGNING WITH <br /> INTENTION
          </h2>
        </div>

        {/* Right: Subheading + Paragraph */}
        <div className="w-full basis-1/2  flex flex-col justify-between  gap-4 md:gap-7  pt-20 md:pt-0 md:py-6   "> 
