...
export default function Hero() {
  return (
    <section className="relative w-screen h-[200px] md:h-[421px] bg-white text-white overflow-hidden pb-2 px-6 flex md:flex-col justify-end">
      <div className=" mt-2 max-screen mx-auto w-full flex flex-col justify-between  md:flex-row md:items-end  h-full gap-y-10">
        <p
          style={{ color: "#0B2204" }}
        ...
        >
          ...
          <p
            style={{ color: "#0B2204" }}
            className="sm:hidden text-5xl font-light leading-none tracking-tight text-[#0B2204]"
          >
            JOURNAL
          </p>
        </p>
