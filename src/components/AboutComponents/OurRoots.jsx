...
const OurRoots = () => {
  return (
    <section className="bg-[#EAE8E5] w-full px-6 lg:px-10 py-20">
      ...
      {/* Stats Row */}
      <div className="grid grid-cols-2  lg:grid-cols-4 gap-0 lg:gap-6 mt-20">
        {[
          { 
            title: "12+",
          ...
          <div
            key={idx}
            className="bg-[#EAE8E5] border border-zinc-400 p-6 text-center lg:h-[180px]"
          >
            <div className="text-[36px] font-serif text-[#2B2B2B] lg:mb-2">
              {item.title}
              {item.superscript && (
