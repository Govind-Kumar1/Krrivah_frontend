  ...
  return (
    <nav>
      <div className="top-0 z-20 w-full border-b border-gray-200 text-gray-900 flex justify-between items-center px-[5.5vw] pt-[2.5vh] py-3">
        {/* Logo */}
        <div className="flex items-center gap-2 -ml-10 md:-ml-20">
          <Link to="/">
            <img
              src="/Logo (2).png"
              alt="Logo"
      ...
      <AnimatePresence>
        {menuOpen && (
          <motion.div
            ...
            className="md:hidden flex flex-col items-center gap-4 px-[5.5vw] pb-6 font-sans font-semibold text-[12px] leading-[100%] tracking-[2px] uppercase bg-white border-b border-gray-200 z-40"
          >
            {navLinks.map((link) => (
              <NavLink
                key={link.name}
